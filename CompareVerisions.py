...
neural_agent_1 = BatchMCTSAgent(search_count=500, load_latest_model=True, batch_size=200, map_size=Amoeba.map_size)
neural_agent_2 = BatchMCTSAgent(search_count=500, load_latest_model=False, batch_size=200, map_size=Amoeba.map_size)
