...
neural_agent = BatchMCTSAgent(search_count=500, load_latest_model=True, batch_size=200, map_size=Amoeba.map_size)
game = GameGroup(batch_size=1, x_agent=neural_agent, o_agent=neural_agent, view=graphical_view)
